# Hello World! I'm José A. Benjumea 👋
...
- [**Phantomime**](https://github.com/Tanwydd/phantomime) — Humanized browser automation library with full anti-detection stack. TLS fingerprinting, Canvas/WebGL spoofing, human-like behavior simulation. Python + Playwright + curl-cffi.
- [**VoiceID**](#) — Forensic-grade voice comparison and deepfake detection system. Compares two audio samples for speaker identity match and flags AI-generated audio. FastAPI + SpeechBrain + Wav2Vec2 + Redis + Docker.
- [**BotFarm**](#) — Docker/Podman-based Python bot management platform with FastAPI + React dashboard. AES-256-GCM credential encryption, JWT auth, real-time log streaming. Built for contact center automation at scale.
- [**tornoBot**](#) — ZKTeco biometric turnstile monitoring and sync system. Multi-device threading, DST-safe scheduling, UDP-only ZK protocol, MySQL event storage.
- [**CronShepherd**](#) — SSH-only cron manager built in PHP + Alpine.js. Manage remote crontabs from a web UI without exposing shell access.

### 📝 Latest Articles

- [Mouse Movement, Typing Speed, and Why Your Bot Still Gets Caught After Fixing TLS](https://dev.to/tanwydd/mouse-movement-typing-speed-and-why-your-bot-still-gets-caught-after-fixing-tls-4obf) *(May 1)*
- [How Your Canvas Fingerprint Gets You Caught (And Why Random Noise Makes It Worse)](https://dev.to/tanwydd/how-your-canvas-fingerprint-gets-you-caught-and-why-random-noise-makes-it-worse-3ba1) *(Apr 25)*
- [Why Playwright Gets You Blocked Even With Proxies](https://dev.to/tanwydd/why-playwright-gets-you-blocked-even-with-proxies-3h2a) *(Apr 18)*
- [Building a Self-Hosted Bot Management Platform with Docker, FastAPI and React](https://dev.to/tanwydd/building-a-self-hosted-bot-management-platform-with-docker-fastapi-and-react-4pdj) *(Apr 15)*
- [Detecting Deepfake Audio in Python: Why the Threshold Matters More Than the Model](https://dev.to/tanwydd/detecting-deepfake-audio-in-python-why-the-threshold-matters-more-than-the-model-3i3l) *(Apr 12)*

### 🤝 Let's Connect

- LinkedIn: [jose-benjumea](https://www.linkedin.com/in/jose-benjumea/)
- Dev.to: [tanwydd](https://dev.to/tanwydd)
...
- [**Phantomime**](https://github.com/Tanwydd/phantomime) — Librería Python de automatización de navegador humanizado con stack anti-detección completo. TLS fingerprinting, Canvas/WebGL spoofing, simulación de comportamiento humano.
- [**VoiceID**](#) — Sistema de comparación de voz con precisión forense y detección de deepfakes. Compara dos muestras de audio para verificar identidad del hablante y detecta audio sintético generado por IA. FastAPI + SpeechBrain + Wav2Vec2 + Redis + Docker.
